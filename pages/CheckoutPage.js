...
class CheckoutPage{
    constructor() { 
        ...
        this.nextShippingBtn = Selector('#shippingoption_1')
        this.nextPaymentBtn = Selector('button.button-1.shipping-method-next-step-button')
        this.nextConfirmBtn = Selector('button.button-1.payment-method-next-step-button')
        this.confirmOrderBtn = Selector('button.button-1.payment-info-next-step-button')
        this.cOrderBtn = Selector('button.button-1.confirm-order-next-step-button')
